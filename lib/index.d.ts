declare module "fancy-units" { 
    ...
    type uVolume = "mm3" | "cm3" | "ml" | "l" | "kl" | "m3" | "km3" | "tsp" | "Tbs" | "in3" | "fl-oz" | "cup" | "pnt" | "qt" | "gal" | "ft3" | "yd3" | "ccf" // Volume
    ...
    class Convert {
        ...
        from(from: unit): this; 
        to(to: unit): number;
        toBest(options?: { exclude?: unit[], cutOffNumber?: number, toSystem?: system }): { val: number, unit: string, singular: string, plural: string };
